(function installCodexWebCopy(globalObject) {
  globalObject.CodexWebCopy = Object.freeze({
    'zh-CN': Object.freeze({
      "Allow once": "允许本次",
      "Cancel turn": "取消任务",
      "Allow with command rule": "按命令规则允许",
      "Approval no longer available": "审批已失效",
      "Delivery unconfirmed": "送达尚未确认",
      "Waiting for your decision": "等待处理",
      "Run a command": "执行命令审批",
      "Change files": "文件修改审批",
      "Grant permissions": "访问权限审批",
      ...
      "Write access": "写入权限",
      "Command rule": "命令规则",
      "Review request": "查看原请求",
      "This also approves the command rule shown above.": "同时批准上方所示的命令规则。",
      "Allow matching requests for this session.": "在本会话中允许同类请求。",
      "Allowed": "已允许",
      "Denied": "已拒绝",
      "Request details exceed the display limit. Approval is unavailable here.": "请求详情超出展示限制，无法在此批准。",
      "Settings sections": "设置分区",
      "Shared server": "共享服务器",
      "Appearance and new-session defaults are saved in this browser.": "外观和新会话默认值保存在当前浏览器中。",
      "These settings apply to this Codex Web server.": "这些设置对当前 Codex Web 服务器生效。",
      "Manage your signed-in devices and access.": "管理你的登录设备与访问权限。",
      "Show key": "显示密钥",
      "Hide key": "隐藏密钥",
      "Account details": "账户详情",
      "Administrative access": "管理员权限",
      "Project access": "项目访问权限",
      "No projects assigned": "未分配项目",
      "Choose a session to review": "选择要查看的会话",
      "View recorded messages and work details in read-only mode.": "以只读方式查看会话记录与工作详情。",
      "Service overview": "服务概况",
      "Managed storage": "受管理存储",
      "Uptime": "运行时间",
      "This user will lose access. This action cannot be undone.": "此用户将无法再访问。此操作无法撤销。",
      "Team accounts and public shares will lose access. You may need to sign in again with the single-user password.": "团队账户和公开分享将无法再访问。你可能需要使用单用户密码重新登录。",
      "Create sessions": "创建会话",
      "Write": "写入",
      "Reason": "原因",
      "Email": "邮箱",
      "Share link unavailable": "分享链接不可用",
      "Shared session could not load": "未能加载分享会话",
      "Check your connection and try again.": "请检查网络连接后重试。",
      "Ask the sender for a new share link.": "请向分享者索取新的链接。",
      "Try again": "重试",
    ...
    'Back to latest': '回到最新',
      ...
      'Sending approval…': '正在发送审批…',
      'Approval delivery is unconfirmed. Refresh the session before trying again.': '审批是否送达尚未确认。请刷新会话后再处理。',
      'This approval is no longer available. Refresh the session.': '此审批已失效，请刷新会话。',
      'Status awaiting sync': '状态待同步',
      'Approval sent': '已发送审批',
