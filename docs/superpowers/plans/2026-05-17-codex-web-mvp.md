...
**Tech Stack:** Node.js >=24, TypeScript NodeNext, built-in `http`, `node:test`, static HTML/CSS/JS, `@codex-mobile-web-app/codex-native-api`.
...
- Do not modify or depend on `../CodexBridge-main`.
